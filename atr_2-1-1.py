...
class AvalonApp:
    ...
    def start_team_proposal(self):
        ...
        rotation = " → ".join(self.original_players)
        tk.Label(self.root, text="Leadership Order:", font=("Arial", 10, "underline")).pack(pady=(5, 0))
        tk.Label(self.root, text=rotation + "\n", font=("Arial", 10), wraplength=400, justify="center").pack()
        if past:
...
# extra line added for linewise differentiation of this version, 2-1-1, from v2-1.
