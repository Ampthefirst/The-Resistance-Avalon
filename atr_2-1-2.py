...
# note that this was a copy of talt2-2_a_.py , but with the scroll mechanism (faulty) disabled.
# Its code is present here as a string.

# New addition; tk.frame "right" is now anchored to 'ne'.